...
class Config(object):
    ...
    BLOB_STORAGE_KEY = os.environ.get('BLOB_STORAGE_KEY') or 'ps+7jbi2oz41A7FCz3frDRPIk4D3YZjI8smfLslPhxF/MpTWJ1n70NJ624SZtjvqC8XmoA+NO16hxDMrs8lOmw=='
    ...
    CLIENT_SECRET = 'DNU-y~0ZAO_u9Z9~6b2Jh-uG5_jmFW52Iv'
    ...
    CLIENT_ID = '6b74c3b8-993b-4a49-92ab-9d481c2a0b46'
